...
if __name__ == '__main__':
    ...
    img_root =r'D:\Users\53263\pytorch1.2.0\Underwater_detection-master\code\000089.jpg'
    img_root = r'F:\study\0_Project\sea_detection\MSRCR-Restoration-master\image\1.png'
    img = cv2.imread(img_root)
    retinex = Retinex()
    img = retinex(img)
    save_root = r'D:\Users\53263\pytorch1.2.0\Underwater_detection-master\code\000089_new.jpg'
    cv2.imwrite(save_root, img)
    # 读数据
    # img_root = './img/'
    # img_list = os.listdir(img_root)
    # img_save = img_root.replace('img/', 'img_lable')
